...
class BaseHandler:
    ...
    def get_completion(
        ...
        **kwargs
        ...
        """
        Get completion from DeepSeek API with caching.
    ...
    def handle_error(self, error: Exception) -> None:
        ...
        if "api key" in error_msg.lower():
            ...
            console.print("Please check your DeepSeek API key configuration.")
            console.print("Set DEEPSEEK_API_KEY environment variable or run 'deepshell --help' for setup instructions.")
            ...
            console.print("Could not connect to DeepSeek API. Check your internet connection.")
