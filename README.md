...
A powerful command-line productivity tool powered by your choice of LLMs—**OpenAI**, **Gemini**, and **DeepSeek**.  
Inspired by Shell GPT, but optimized for multi-provider flexibility and DevOps productivity.
